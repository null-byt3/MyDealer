...
public class ClientDBinitializer {
	...
	public static ClientDB getDB() {
		...
		Client client4 = new Client(serializer.getNextId("clientId"),1000, "Scarlett", "Johanson", "Female", "Ramat Gan", "Weinstein 23/9", "08-9224892","YeledZevel@hit.ac.il");
		Client client5 = new Client(serializer.getNextId("clientId"),1005, "Noam", "Miadanee", "Male", "Ashdod", "Hahamim 3", "08-9451062", "NoamMiadanee@gmail.com");
		...
		Client client11 = new Client(serializer.getNextId("clientId"),1005, "Natalia", "Allen", "Female","Haifa", "Dizengoff 20/4", "054-3345878", "jsmith@example.com");
