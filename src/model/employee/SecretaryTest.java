...
class SecretaryTest {
	...
	void setUp() throws Exception {
		...
		password = "12345";
		salary = 10500;
		tester = new Secretary(2000, firstName, lastName, gender, userName, password, salary);
	}
	...
	void testSetFirstName() {
		...
		String expected = SecretaryTest.firstName;
	...
	void testSetLastName() {
		...
		String expected = SecretaryTest.lastName;
	...
	void testSetGender() {
		...
		String expected = SecretaryTest.gender;
	...
	void testSetSalary() {
		...
		int expected = SecretaryTest.salary;
	...
	void testSetUserName() {
		Employee tester2 = new Secretary(2001, "Donald", "Trump", "Male", "dondon", "abc123", 100000000);
		tester.setUserName("dondon");
		String expected = SecretaryTest.userName;
